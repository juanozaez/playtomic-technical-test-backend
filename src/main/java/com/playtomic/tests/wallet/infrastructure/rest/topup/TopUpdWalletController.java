...
public class TopUpdWalletController {
    ...
    public void topUpWallet(@PathVariable String id,
        ...
        maker.topUp(WalletId.fromString(id),
                transactionRequest.amount(),
                new Card(new CardNumber(transactionRequest.creditCard().cardNumber())),
                TransactionId.fromString(transactionRequest.transactionId()));
    }
}